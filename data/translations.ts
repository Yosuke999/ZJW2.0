...
const en: Copy = {
  ...
  confirmedDate: "Demo price checked on",
  ...
  landedCostResult: "Final landed cost (to be verified)",
...
export const translations: Record<Language, Copy> = {
  ...
  ru: {
    ...
    confirmedDate: "Дата проверки демо-цен",
  ...
  ky: {
    ...
    confirmedDate: "Демо баа текшерилген күн",
  ...
  uz: {
    ...
    confirmedDate: "Demo narx tekshirilgan sana",
