...
const en: Copy = {
  ...
  brandName: "Central Asia Opportunity Portal",
  heroTitle: "Source from China and sell in your local market",
  heroSubtitle: "Compare reference local retail prices with reference wholesale prices in China",
  localPrice: "Local retail reference",
  chinaPrice: "China sourcing reference",
  priceDisclaimer: "Prices are for preliminary product selection only",
  demoData: "Demo data · verification required",
  confirmedDate: "Price confirmed on",
  popularTitle: "More popular products",
  popularTag: "Popular",
  productCategoryAll: "All products",
  productCategoryLabels: { electronics: "Electronics", home: "Home", personal: "Personal care", daily: "Everyday goods" },
  showMore: "Show more",
  showLess: "Show less",
  viewDetails: "View details",
  productDetails: "Product details",
  referenceDifference: "Reference price difference",
  differenceDisclaimer: "The reference price difference is not actual profit.",
  landedCostParts: ["China sourcing price", "freight · customs · taxes", "local delivery"],
  landedCostResult: "Estimated landed cost",
  consultProduct: "Ask about this product",
  priceNoteTitle: "How to read the prices",
  ...
  floatingConsult: "Contact",
  consultHelp: "Support with sourcing, inspection, freight, customs and delivery",
  contactTitle: "Choose a contact channel",
  demoContact: "Contact details",
  contactNote: "Prepare the product, quantity and destination city to begin verification.",
  contactOutcomesTitle: "We will verify three points",
  contactOutcomes: ["Available specifications, quantity and minimum order", "Cost breakdown and estimated total to your city", "Shipping method and estimated delivery window"],
  serviceTitle: "From product selection to local delivery",
  servicePhases: [
    { label: "Initial confirmation", range: "01–03", steps: [
      { title: "Find an opportunity", description: "Review products with a visible price difference", duration: "Immediately", deliverable: "Product shortlist" },
      { title: "Confirm requirements", description: "Confirm product, quantity and budget", duration: "1 business day", deliverable: "Confirmed request" },
      { title: "Match suppliers", description: "Verify suppliers and prepare a quotation", duration: "2–3 business days", deliverable: "Quotation and sourcing advice" },
    ] },
    { label: "Fulfilment and delivery", range: "04–05", steps: [
      { title: "Purchase and freight", description: "Purchase, inspection, consolidation, freight and customs", duration: "Per order", deliverable: "Inspection and shipment updates" },
      { title: "Local handover", description: "Confirm receipt and begin selling", duration: "After arrival", deliverable: "Delivery confirmation" },
    ] },
  ],
  faqTitle: "Frequently asked questions",
  faqs: [
    { question: "Do prices include freight and customs?", answer: "No. Terms are confirmed separately according to the product, quantity, destination and shipping method." },
    { question: "How do I get a complete quotation?", answer: "Use any contact channel on the page. Terms are confirmed separately according to the product, quantity, destination and shipping method." },
    { question: "What is the minimum order quantity?", answer: "It depends on the product and supplier and will be confirmed with your request." },
    { question: "How long does delivery take?", answer: "The estimate depends on the destination and shipping method and will be confirmed with your request." },
    { question: "Which sourcing and delivery services are available?", answer: "Support may include sourcing, inspection, consolidation, freight, customs and local delivery; the exact scope is confirmed after your inquiry." },
  ],
  finalTitle: "Found a product? Confirm its price and delivery plan",
  localAdvisor: "Contact a local advisor",
  footerPriceNote: "Price information",
  privacy: "Privacy policy",
  close: "Close",
  previous: "Previous product",
  next: "Next product",
  language: "Language",
  contactCountry: "Service country",
  contactProduct: "I am interested in this product",
  selectedProduct: "Product selected — continue below to request advice",
};
...
export const translations: Record<Language, Copy> = {
  ...
  ru: {
    ...
    confirmedDate: "Дата подтверждения цены",
    ...
    landedCostResult: "Расчётная итоговая стоимость доставки",
  ...
  ky: {
    ...
    confirmedDate: "Бааны ырастоо күнү",
    ...
    landedCostResult: "Болжолдуу акыркы жеткирүү баасы",
  ...
  uz: {
    ...
    confirmedDate: "Narx tasdiqlangan sana",
    ...
    landedCostResult: "Taxminiy yakuniy yetib kelish xarajati",
